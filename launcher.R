getArgs = function(){
  option_list = list(
    ...
    make_option(c( "--output3"), type="character", default="pca", 
                metavar="character", help="PCA file name [default: %default]"),
    make_option(c( "--output4"), type="character", default="heatmap", 
                metavar="character", help="Heatmap file name [default: %default]"),
    make_option(c( "--output5"), type="character", default="summary", 
                metavar="character", help="Summary file name [default: %default]"),
    make_option(c( "--output6"), type="character", default="clusters", 
                metavar="character", help="Clusters file name [default: %default]"),
    make_option(c( "--output7"), type="character", default="dendrogram", 
...
for (l in librairies){
  if (! (l %in% installed.packages()[,"Package"])) install.packages(l, repos = "https://cran.r-project.org", quiet = T)
