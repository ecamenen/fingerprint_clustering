getArgs <- function() {
    option_list <- list(
        ...
        make_option(c("-n", "--nbClusters"),
            type = "integer", metavar = "integer",
            help = "Fix the number of clusters"
        ),
        make_option(c("-d", "--distance"),
            type = "integer", default = 1, metavar = "integer",
        ...
        make_option(c("-H", "--header"),
            type = "logical", action = "store_false",
            help = "Consider first row as header of columns"
        ),
        make_option(c("-s", "--separator"),
            type = "integer", metavar = "integer", default = 1,
            help = "Type of separator [default: tabulation] (1: Tabulation, 2: Semicolon"
        ),
        make_option(c("-N", "--nbAxis"),
            type = "integer", default = 2, metavar = "integer",
